...
public class Register extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		// if an user name is entered, along with a password
			...
			if (pass.equals(confirm)) {
				try {
					...
					while (line != null) {
						...
						// check password against what's in the file, see if
					...
					input.close();
					//after this point, the user and password are new. Store them!
